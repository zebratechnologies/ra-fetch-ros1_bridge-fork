...
<details>
    ...
    <ul>
        <li> Zebra Business Unit : EMC - RA </li>
        <li> Zebra Manager : rctoris </li>
        <li> Zebra Repo Admin: am3674 </li>
        <li> Zebra Jira Project ID: RND  </li>
        <li> Product: Fetch </li>
        <li> Topics: bu-emc-ra </li>
    </ul>
</details>
<div>
...
Unauthorized access, copying or sharing of any code stored on this site is prohibited and will be prosecuted.</div>
